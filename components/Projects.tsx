...
const projects = [
  {
    ...
    description: 'Moving beyond simple ChatGPT wrappers. We architect specialized, multi-agent AI workflows that autonomously handle research, data orchestration, and generation for your enterprise clients. The result? A production-grade SaaS that delivers high-quality, customized proposals at scale, freeing your team to focus on closing deals and building relationships.',
  ...
  {
    id: 'outreach-engine', 
    title: 'Custom CRMs & Client Portals', 
    status: 'Live',
    description: 'Stop relying on off-the-shelf software. We build fully custom data pipelines, analytics dashboards, and automated outreach systems tailored to your clients exact workflows.',
